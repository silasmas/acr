...
<body class="font-sans text-gray-900 antialiased">
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                <a href="{{ route('home') }}"
                    class="nav-item nav-link mt-1 {{ Route::is('home') ? 'active' : '' }}">@lang('miscellaneous.menu.home')</a>
                <a href="{{ route('about.home') }}"
                    class="nav-item nav-link mt-1 {{ Route::is('about.home') || Route::is('about.party') || Route::is('about.app') || Route::is('about.terms_of_use') || Route::is('about.privacy_policy') || Route::is('about.help') || Route::is('about.faq') ? 'active' : '' }}">@lang('miscellaneous.menu.public.about')</a>
                <a href="{{ route('news.home') }}"
                    class="nav-item nav-link mt-1 {{ Route::is('news.home') || Route::is('news.datas') ? 'active' : '' }}">@lang('miscellaneous.menu.public.news')</a>
                <a href="{{ route('works') }}"
                    class="nav-item nav-link mt-1 {{ Route::is('works') ? 'active' : '' }}">@lang('miscellaneous.menu.public.works')</a>
                @empty(Auth::user())
                <span class="nav-item dropdown d-lg-inline-block d-none mb-0">
                    <a href="#" class="nav-link" data-bs-toggle="dropdown"><i
                            class="bi bi-translate fs-4 align-top"></i></a>
            ...
            <div class="border-start ps-lg-4 ps-0">
                ...
                <div id="publicNotification"
                    class="{{ $current_user->notifications[0]->status->status_name == 'Non lue' ? 'dropdown ' : '' }}d-inline-block my-3 ms-lg-0 ms-4 me-3">
                    <a role="button" href="{{ route('notification.home') }}" id="notificationLink"
                        class="{{ $current_user->notifications[0]->status->status_name == 'Non lue' ? '' : 'text-secondary' }}"
                        data-mdb-toggle="{{ $current_user->notifications[0]->status->status_name == 'Non lue' ? 'dropdown' : '' }}"
                        aria-expanded="false">
                        <i
                            class="bi {{ $current_user->notifications[0]->status->status_name == 'Non lue' ? 'bi-bell-fill ' : 'bi-bell ' }}fs-4 align-middle"></i>
                        @if ($current_user->notifications[0]->status->status_name == 'Non lue')
                        <span
                            class="position-absolute top-0 start-100 translate-middle p-1 border border-4 border-danger rounded-circle">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end mt-3" aria-labelledby="notificationLink"
                        ...
                        <li class="text-center">
                            <a id="markAllRead" href="#" class="dropdown-item py-3 acr-bg-gray"
                        ...
                        @if ($loop->index < 3) <li class="border-bottom border-secondary w-100">
                            ...
                            <li class="text-center">
                                <a href="{{ route('notification.home') }}"
                                    class="dropdown-item py-3 acr-bg-blue-transparent text-light">
                                    @lang('miscellaneous.see_all_notifications') <i
                                        class="fa fa-angle-right align-middle ms-2 fw-100"
                ...
                <div id="avatar" class="dropdown d-inline-block my-3 ms-lg-0 me-1">
                    <a role="button" href="" id="avatarLink" data-mdb-toggle="dropdown" aria-expanded="false">
                        <img src="{{ $current_user->avatar_url != null ? $current_user->avatar_url : asset('assets/img/user.png') }}"
                            alt="{{ $current_user->firstname . ' ' . $current_user->lastname }}" width="40"
    ...
    <div class="container">
        <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
            <p class="section-title bg-white text-center text-primary px-3">
                @lang('miscellaneous.menu.public.donate')</p>
            <h1 class="mb-5">@lang('miscellaneous.public.home.donate.title')</h1>
        </div>
        <div class="row g-5">
            <div class="col-lg-6">
                <div class="bg-image mb-4 wow fadeInUp" data-wow-delay="0.3s">
                    <img src="{{ asset('assets/img/donations.png') }}"
                        alt="@lang('miscellaneous.menu.public.donate')" class="img-fluid">
                    <div class="mask"></div>
                </div>

                <p class="mb-4 wow fadeInUp" data-wow-delay="0.5s">
                    @lang('miscellaneous.public.home.donate.content1')</p>
                <p class="mb-4 wow fadeInUp" data-wow-delay="0.5s">
                    @lang('miscellaneous.public.home.donate.content2')</p>
                <p class="m-0 wow fadeInUp" data-wow-delay="0.5s">@lang('miscellaneous.public.home.donate.content3')
                </p>
            </div>
                ...
                <form method="POST" action="{{ route('donate') }}">
                    ...
                    {{-- <div id="donationType" class="mb-4">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="offer_type_id" id="anonyme"
                                value="{{ $type->id }}" />
                            <label class="form-check-label"
                                for="anonyme">@lang('miscellaneous.public.home.donate.anonyme')</label>
                        </div>
                        @else
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="offer_type_id" id="partner"
                                value="{{ $type->id }}" />
                            <label class="form-check-label"
                                for="partner">@lang('miscellaneous.public.home.donate.partner')</label>
                        </div>
                        @endif
                        @endif
                        @endforeach
                    ...
                    <div id="donorIdentity" class="row g-3 mb-4">
                        <div class="col-12">
                            <h5 class="h5 m-0 text-uppercase fw-bolder">
                                @lang('miscellaneous.public.home.donate.your_identity')</h5>
                        </div>

                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="register_firstname"
                                    placeholder="@lang('miscellaneous.firstname')">
                        ...
                        <div class="col-lg-5">
                            <div class="form-floating pt-0">
                                <select name="select_country_user" id="select_country2"
                        ...
                        <div class="col-lg-7">
                            <div class="input-group">
                                <span id="phone_code_text2" class="input-group-text d-inline-block h-100 bg-light"
                                    style="padding-top: 0.3rem; padding-bottom: 0.5rem; line-height: 1.35;">
                                    <small class="text-secondary m-0 p-0"
                                        style="font-size: 0.85rem; color: #010101;">@lang('miscellaneous.phone_code')</small><br>
                                    <span class="text-value">xxxx</span>
                                </span>

                                <div class="form-floating">
                                    <input type="tel" name="phone_number_user" id="phone_number_user"
                        ...
                        <div class="col-md-12">
                            <div class="form-floating">
                                <input type="email" name="register_email" id="register_email" class="form-control"
                                    placeholder="@lang('miscellaneous.email')">
                    ...
                    <div id="otherDonation" class="row mt-1 mb-4 g-3">
                        <div class="col-12">
                            <h5 class="h5 m-0 text-uppercase fw-bolder">
                                @lang('miscellaneous.public.home.donate.other_donation.title')</h5>
                        </div>

                        <div class="col-12">
                            <div class="form-floating">
                                <textarea name="register_offer_name" id="register_offer_name" class="form-control"
                                    placeholder="Décrivez votre don" style="height: 100px"></textarea>
                                <label
                                    for="register_offer_name">@lang('miscellaneous.public.home.donate.other_donation.description')</label>
                            </div>
                        </div>
                    </div>

                    <button class="btn btn-block btn-secondary rounded-pill py-3 px-5"
                        type="submit">@lang('miscellaneous.send')</button>
                </form>
            </div>
        </div>
    </div>
   ...
   @endif
        ...
        <div class="container py-4">
            <div class="row g-5">
                <div class="col-lg-5 col-md-6">
                    ...
                    <p class="mb-2"><i
                            class="fa fa-map-marker-alt me-3"></i>@lang('miscellaneous.public.footer.head_office.address')
                    </p>
                    <p class="mb-2"><i
                            class="fa fa-phone-alt me-3"></i>@lang('miscellaneous.public.footer.head_office.phone')</p>
                    <p class="mb-2"><i
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <a href="{{ route('about.home') }}"
                        class="btn btn-link bg-transparent fs-6">@lang('miscellaneous.menu.public.about')</a>
                    <a href="{{ route('news.home') }}"
                        class="btn btn-link bg-transparent fs-6">@lang('miscellaneous.menu.public.news')</a>
                    <a href="{{ route('works') }}"
                        class="btn btn-link bg-transparent fs-6">@lang('miscellaneous.menu.public.works')</a>
                    <a href="{{ route('donate') }}"
                        class="btn btn-link bg-transparent fs-6">@lang('miscellaneous.menu.public.donate')</a>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="position-relative w-100">
                        <form action="" method="post">
                            <input type="text" class="form-control bg-transparent w-100 py-3 ps-4 pe-5 text-white"
                                placeholder="@lang('miscellaneous.public.footer.newsletter.email')">
                            <button type="submit"
                                class="btn btn-secondary text-primary position-absolute top-0 end-0 mt-2 me-2"
                                style="padding: 0.8rem 0.8rem;">@lang('miscellaneous.public.footer.newsletter.submit')</button>
                        </form>
                    </div>
                </div>
            </div>
    ...
    <!-- Back to Top -->
    <a href="#" class="btn btn-lg acr-btn-yellow btn-lg-square rounded-circle back-to-top"><i
