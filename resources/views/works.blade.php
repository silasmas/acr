            ...
            @if ($loop->index < 4 && $o_n->id != $news->id)
                ...
                @endif
                            <div class="{{ !empty($o_n->photo_url) ? 'col-lg-7 col-sm-8 ' : '' }}col-12">
                                <a href="{{ route('work.datas', ['id' => $o_n->id]) }}">
                ...
                @endif
                                    <a class="btn fw-bold py-2 ps-0 pe-3 border-bottom border-3 border-danger rounded-0 shadow-0" href="{{ route('work.datas', ['id' => $o_n->id]) }}">
        ...
        @forelse ($news as $news_item)
            ...
            @endif
                                                ...
                                                <div class="col-md-10 col-12">
                                                    <div class="badge {{ $news_item->type->type_name == 'Communiqué' ? 'badge-warning' : 'badge-primary' }} mb-2">{{ $news_item->type->type_name }}</div>
                                                    ...
                                                    <p class="mt-2 mb-1 text-black acr-line-height-1_45">{{ Str::limit($news_item->news_content, 150, '...') }}</p>
                                                    <p class="mb-2">
                                                        <a class="btn fw-bold py-2 ps-0 pe-3 border-bottom border-3 border-danger rounded-0 shadow-0" href="{{ route('work.datas', ['id' => $news_item->id]) }}">
                                                            {{ __('miscellaneous.see_more') }}
                                                        </a>
                                                    </p>
                                                </div>
