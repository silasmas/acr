...
(function ($) {
    ...
    /**
     * AFTER CLICK ON MODAL BUTTON, MANAGE PREVIOUSLY LOADED CONTENT
     * 
     * @param _ajaxLoading
     * @param _formURL
     * @param _formData
     ...
     */ 
     $.fn.onClickRunModalLoadedContent = function (_ajaxLoading, _formURL, _formData, _resultURL, _resultData, _wrapper, _reloadWrapperURL) {
        this.each(function () {
    ...
    /**
     * ON CLICK, CREATE NEW ELEMENT WITH DATA AND SEND DATA ASYNCHRONOUSLY
     * 
     * @param _ajaxLoading
     * @param _newIcon
     * @param _lastElement
     */ 
     $.fn.onClickRegister = function (_ajaxLoading, _newIcon, _lastElement) {
        this.each(function () {
            $(this).on('click', function () {
                $(_ajaxLoading).removeClass('opacity-0');

                var newIcon = document.querySelector(_newIcon);
                var mForm = new FormData();

                mForm.append('sentData', newIcon.value);

                $(_lastElement).after('<p class="mt-0 mb-2"><i class="' + mForm.get('sentData') + ' fs-2 align-middle"></i><span class="blp-chip blp-chip-light ms-2 me-2"><span class="content">' + mForm.get('sentData') + '</span><a class="blp-pointer close"><i class="fa fa-close"></i></a></span><a href="" id="changeIcon" class="d-inline-block align-middle small"></a></p>');
                $(this).addClass('disabled');
                $(newIcon).addClass('disabled');
    ...
    $.fn.uploadImage = function (_modal, _inputFile, _apiUrl, _entity_id) {
        this.each(function () {
            ...
            $(_modal + ' #crop').click(function () {
                ...
                $(this).attr('src', 'https://biliap-admin.dev:1443/assets/img/ajax-loading.gif');
            ...
            $('* .theme-toggler').on('click', function (e) {
                ...
                if (_this.hasAttribute('blp-user-id')) {
                    ...
                    $.ajax({
                        ...
                        type: 'GET',
                        contentType: 'application/json',
                        url: 'https://biliap-admin.dev:1443/api/preference/select_by_entity/user/' + userId,
                        success: function (result) {
                            // If user preference exists
                            if (result !== null) {
                                // If user has a prefered theme, set theme according to user preference
                                if (result.data.prefered_theme !== null) {
                                    if (result.data.prefered_theme === 'Dark') {
                                        ...
                                        $.ajax({
                                            ...
                                            type: "PUT",
                                            contentType: 'application/json',
                                            url: 'https://biliap-admin.dev:1443/api/preference/switch_theme/' + result.data.id + '/Light',
                                            dataType: 'json',
                                        ...
                                        $.ajax({
                                            ...
                                            type: "PUT",
                                            contentType: 'application/json',
                                            url: 'https://biliap-admin.dev:1443/api/preference/switch_theme/' + result.data.id + '/Dark',
                                            dataType: 'json',
                                ...
                                // If user hasn't a prefered theme, change theme and create user preference adding that theme
                                    ...
                                    if ($(_this).attr('blp-theme') === 'Light') {
                                        ...
                                        $.ajax({
                                            ...
                                            type: 'POST',
                                            contentType: 'application/json',
                                            url: 'https://biliap-admin.dev:1443/api/preference',
                                            dataType: 'json',
